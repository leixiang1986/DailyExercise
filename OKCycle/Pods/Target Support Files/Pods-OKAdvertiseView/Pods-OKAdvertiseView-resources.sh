...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "Okdeer-CommonLibrary/OkdeerCommonLibrary/ThirdPartManager/Lib/AliPay/AlipaySDK.bundle"
  install_resource "Okdeer-CommonLibrary/OkdeerCommonLibrary/ThirdPartManager/ShareManager/Resource/UMSocialSDKResources.bundle"
  install_resource "Okdeer-CommonLibrary/OkdeerCommonLibrary/view/view.bundle"
